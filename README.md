...
I'm a graduate student at Kyushu University (Systems Life Sciences) and a developer working mainly with Java, JavaScript, and data-driven applications.  
My research focuses on ribosome-induced transdifferentiation, cell culture technology, and applications for sustainable cultured meat.
...
![R](https://img.shields.io/badge/R-Statistics-lightblue?logo=r)

### Development Tools
![IntelliJ IDEA](https://img.shields.io/badge/IntelliJIDEA-IDE-red?logo=intellijidea)
...
![Terminal](https://img.shields.io/badge/Mac-Terminal-black?logo=apple)
...
- **Scientific Data Visualization Scripts (R)**  
  ANOVA, Tukey test, EnhancedVolcano, ggplot2 graphs for cell proliferation and gene expression.
...
<!--
**INOUE6050/INOUE6050** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
